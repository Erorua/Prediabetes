...
%%% Data from Segal Cohort - Male

%%% output: file "Male_cohort_Si_rate_change.txt"
...
Datap=readtable('./Male_Infos_Header.txt');
...
% 
 save Male_cohort_Si_rate_change.txt Hero -ASCII 
