...
%%% Data from Segal Cohort - Female

%%% output: file "Female_cohort_Si_rate_change.txt"
...
Datap=readtable('./Female_Infos_Header.txt');
...
% 
 save Female_cohort_Si_rate_change.txt Hero -ASCII 
