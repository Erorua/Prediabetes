function Si_rate_change_prediab
...
%%% For prediabetic cohort

%%% Bootstrapping to calculate variability of the mode

%%% input: Si rate of change file : "Prediabetic_cohort_Si_rate_change.txt"
...
m=load('./Prediabetic_cohort_Si_rate_change.txt');
