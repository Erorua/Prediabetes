...
%%% Data from Segal Cohort - Diabetic people

%%% output: file "Diabetic_cohort_Si_rate_change.txt"
...
Data=[table2array(Datad)]; % matrix [Reg Date G I gender Age BMI]
...
% 
 save Diabetic_Si_rate_change.txt Hero -ASCII 
